# GameOrg OpenAPI Specification
[![Build Status](https://travis-ci.org/ajbdev/gameorg-api.svg?branch=master)](https://travis-ci.org/ajbdev/gameorg-api)
...
6. If you did everything correct, https://ajbdev.github.io/gameorg-api/ will lead to your new docs
...
- Documentation(ReDoc): https://ajbdev.github.io/gameorg-api/
- SwaggerUI: https://ajbdev.github.io/gameorg-api/swagger-ui/
- Look full spec:
    + JSON https://ajbdev.github.io/gameorg-api/swagger.json
    + YAML https://ajbdev.github.io/gameorg-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://ajbdev.github.io/gameorg-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://ajbdev.github.io/gameorg-api/ with url from the message: `Server started <url>`
